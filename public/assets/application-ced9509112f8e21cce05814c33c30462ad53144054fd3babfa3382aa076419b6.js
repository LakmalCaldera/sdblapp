    ...
    Agents.prototype.index = function () {
        return $(function () {
            ...
            $('#agentTable tbody').on('click', 'button', function () {
                ...
                $.confirm({
                    title: 'Confirm!',
                    content: "Are you sure you want to delete agent " + data.account + "?",
                    buttons: {
                        confirm: function () {
                            clientComm.delete("agents", data.account, function (res) {
                                alert("Successfully deleted agent and all its transactions.");
                                $.confirm({
                                    title: 'Success!',
                                    content: "Deleted agent " + data.account + " and all its transactions.",
                                    type: 'green',
                                    typeAnimated: true,
                                    buttons: {
                                        ok: {
                                ...
                                //alert("Error trying to delete agent. Please contact admin.");
                                $.confirm({
                                    title: 'Error!',
                                    content: err,
                                    type: 'red',
